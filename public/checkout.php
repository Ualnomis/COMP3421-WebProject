...
<div class="page-body">
    <div class="container-xl">
        <div class="row">
            ...
            <div class="col-8">
                <form method="POST" action="../includes/pay.php">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row row-cards">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Card Number" value="">
                                </div>
